c     subroutine zblas2()
*
c     CALL ZGEMV ( TRANS, M, N, ALPHA, A, LDA, X, INCX,
c    $                   BETA, Y, INCY )
*
c     CALL ZGBMV ( TRANS, M, N, KL, KU, ALPHA, A, LDA, X, INCX,
c    $                   BETA, Y, INCY )
*
c     CALL ZHEMV ( UPLO, N, ALPHA, A, LDA, X, INCX,
c    $                   BETA, Y, INCY )
*
c     CALL ZHBMV ( UPLO, N, K, ALPHA, A, LDA, X, INCX,
c    $                   BETA, Y, INCY )
*
c     CALL ZHPMV ( UPLO, N, ALPHA, AP, X, INCX, BETA, Y, INCY )
*
c     CALL ZTRMV ( UPLO, TRANS, DIAG, N, A, LDA, X, INCX )
*
c     CALL ZTBMV ( UPLO, TRANS, DIAG, N, K, A, LDA, X, INCX )
*
c     CALL ZTPMV ( UPLO, TRANS, DIAG, N, AP, X, INCX )
*
c     CALL ZTRSV ( UPLO, TRANS, DIAG, N, A, LDA, X, INCX )
*
c     CALL ZTBSV ( UPLO, TRANS, DIAG, N, K, A, LDA, X, INCX )
*
c     CALL ZTPSV ( UPLO, TRANS, DIAG, N, AP, X, INCX )
*
c     CALL ZGERU ( M, N, ALPHA, X, INCX, Y, INCY, A, LDA )
*
c     CALL ZGERC ( M, N, ALPHA, X, INCX, Y, INCY, A, LDA )
*
c     CALL ZHER  ( UPLO, N, ALPHA, X, INCX, A, LDA )
*
c     CALL ZHPR  ( UPLO, N, ALPHA, X, INCX, AP )
*
c     CALL ZHER2 ( UPLO, N, ALPHA, X, INCX, Y, INCY, A, LDA )
*
c     CALL ZHPR2 ( UPLO, N, ALPHA, X, INCX, Y, INCY, AP )
*
c     stop
c     end
