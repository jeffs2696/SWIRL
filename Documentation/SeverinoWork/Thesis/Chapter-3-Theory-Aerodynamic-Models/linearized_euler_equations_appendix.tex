...
governing equations. Starting with the Conservation of Momentum in the r direction,
\[
\frac{\partial v_r'}{\partial t} +
...
The mean flow derivatives $\partial A/ \parial r$ and $\partial (\bar{\rho A^2) /\partial r $

    \begin{align*}
        \frac{1}{A}\frac{\partial A}{ \partial \tilde{r}} &= \frac{r_T}{A^2}\left( A \frac{\partial A}{\partial r} \right)
    \end{align*}
