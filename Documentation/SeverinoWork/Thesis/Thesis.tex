...
\usepackage[]{hyperref}
% \hypersetup{
%     pdftitle={V_and_V_Method_for_Acs_Mode_Prediction_Code_MS_Thesis.pdf},
%     pdfauthor={Jeffrey Severino},
%     pdfsubject={Turbomachinery Noise},
%     pdfkeywords={Aeroacoustics, Acoustics, Aerodynamics},
...
\begin{listofsymbols}
    ...
    \emblem{$\textbf{e}_x$,$\textbf{e}_{\theta}$ }{unit vectors for the axial and
    ...
    \emblem{$\bar{r}_{Shankar}$      }{dimensionless radial coordinate in \ref{Shankar} , $r/b = r/(r_{max} - r_{min})$}
...
% \input{Chapter-1-Introduction/Ch-1-Intro} 
\chapter{Literature Review}
% \input{Chapter-2-Literature-Review/Ch-2-intro}
% \input{Chapter-2-Literature-Review/Ch-2-main-body}
% \input{Chapter-2-Literature-Review/Ch-2-golubev-atassi-work}
% \input{Chapter-2-Literature-Review/Ch-2-conclusion}


\chapter{Theoretical Framework and Methods}
\input{Chapter-3-Theory-Aerodynamic-Models/Ch-3-intro}
...
\input{Chapter-3-Theory-Aerodynamic-Models/linearized_euler_equations}
\newpage
(place holder for analytics)
\newpage
\chapter{Verification and Validation Techniques for Numerical Approximations} 

% \input{Chapter-3-Theory-Aerodynamic-Models/AnalyticalDuctModes}

% \chapter{Chapter 4: Numerical Models}
% \section{Numerical Integration}

\input{Chapter-4-Theory-Numerical-Models/Theory-Numerical-Integration/introduction}
\include{Chapter-4-Theory-Numerical-Models/Theory-Numerical-Integration/order-of-accuracy}

\include{Chapter-4-Theory-Numerical-Models/Theory-Numerical-Integration/methods}
% \include{Chapter-4-Theory-Numerical-Models/Theory-Numerical-Integration/theory}

\include{Chapter-4-Theory-Numerical-Models/Theory-Numerical-Integration/procedure}
% \section{Fairing Functions}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/intro}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/setting-bc-values-using-a-fairing-function}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/min-boundary-polynomial}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/max-boundary-polynomial}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/symbolic-sanity-checks}
\input{Chapter-4-Theory-Numerical-Models/Theory-Fairing-Functions/min-boundary-polynomial-derivative}
\chapter{Results and Discusssion}
\section{Verification of Numerical Schemes using the Method of Manufactured Solution}

% \input{Chapter-5-Results/Ch-5-intro}
% \input{Chapter-5-Results/Ch-5-results-and-discussion}
...
%%    \input{Chapter-5-Results/tex-outputs/MachDistribution_R1.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/PerturbationVariables_R1.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/SoundSpeedFromIntegration_R1.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/SourceTermData_R1.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/L2_R1.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/ROC_R1.tex} 
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/L2_R2.tex}
%%    \newpage
%%    \input{Chapter-5-Results/tex-outputs/ROC_R2.tex} 
%%
...
%% \input{Chapter-5-Results/Table4_3_results}
...
%% \input{Chapter-5-Results/Table4_4_results}
...
% \include{Chapter-3-Theory-Aerodynamic-Models/speed_of_sound_derivation}
% \include{Chapter-3-Theory-Aerodynamic-Models/isentropic_relationships}
% \include{Chapter-3-Theory-Aerodynamic-Models/linearized_euler_equations_appendix}
