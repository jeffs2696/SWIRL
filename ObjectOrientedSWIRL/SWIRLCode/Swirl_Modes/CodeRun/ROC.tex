...
%% Sun 18 Jul 2021 04:44:17 PM EDT
...
\node[gp node center] at (3.245,0.677) {$50$};
\gpcolor{color=gp lt color axes}
\gpsetlinetype{gp lt axes}
\gpsetdashtype{gp dt axes}
\gpsetlinewidth{0.50}
...
\node[gp node center] at (4.985,0.677) {$100$};
\gpcolor{color=gp lt color axes}
\gpsetlinetype{gp lt axes}
\gpsetdashtype{gp dt axes}
\gpsetlinewidth{0.50}
...
\node[gp node center] at (6.726,0.677) {$150$};
\gpcolor{color=gp lt color axes}
\gpsetlinetype{gp lt axes}
\gpsetdashtype{gp dt axes}
\gpsetlinewidth{0.50}
...
\node[gp node center] at (8.466,0.677) {$200$};
\gpcolor{color=gp lt color axes}
\gpsetlinetype{gp lt axes}
\gpsetdashtype{gp dt axes}
\gpsetlinewidth{0.50}
\draw[gp path] (10.207,0.985)--(10.207,7.953);
\draw[gp path] (10.207,8.261)--(10.207,8.441);
\gpcolor{color=gp lt color border}
\gpsetlinetype{gp lt border}
\gpsetdashtype{gp dt solid}
\gpsetlinewidth{1.00}
...
\node[gp node center] at (10.207,0.677) {$250$};
\gpcolor{color=gp lt color axes}
\gpsetlinetype{gp lt axes}
\gpsetdashtype{gp dt axes}
\gpsetlinewidth{0.50}
...
\node[gp node center] at (6.725,0.215) {Number of Gridpoints};
...
\draw[gp path] (1.608,8.307)--(1.678,5.509)--(1.817,3.515)--(2.096,2.326)--(2.653,1.676)%
  --(3.767,1.336)--(5.994,1.162)--(10.450,1.074);
\gpsetpointsize{4.00}
\gppoint{gp mark 1}{(1.608,8.307)}
\gppoint{gp mark 1}{(1.678,5.509)}
\gppoint{gp mark 1}{(1.817,3.515)}
\gppoint{gp mark 1}{(2.096,2.326)}
\gppoint{gp mark 1}{(2.653,1.676)}
\gppoint{gp mark 1}{(3.767,1.336)}
\gppoint{gp mark 1}{(5.994,1.162)}
\gppoint{gp mark 1}{(10.450,1.074)}
