...
silent only
silent tabonly
cd ~/SWIRL/ObjectOrientedSWIRL/SWIRLCode/Swirl_Modes/SourceFiles/srcF2020
...
let s:l = 307 - ((31 * winheight(0) + 31) / 62)
...
normal! 0
tabnext
edit ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/Makefile
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 314 - ((35 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
314
...
normal! 09|
tabnext
edit ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/OuterCode.f90
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 550 - ((38 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
550
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 419 - ((30 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
419
normal! 09|
tabnext
edit ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/SwirlClassObj.f90
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 454 - ((30 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
454
...
badd +1 Makefile
badd +1 main.f90
badd +1 swirlClassObject.f90
badd +0 README
badd +1 ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/OuterCode.f90
badd +1 ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/Makefile
badd +1 ../../../../../Archive/ObjectOrientedSwirlCode/srcObj/SwirlClassObj.f90
