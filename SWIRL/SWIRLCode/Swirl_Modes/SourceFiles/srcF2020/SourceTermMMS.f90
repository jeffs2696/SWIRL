...
! i - imaginary number
    ...
    S_3 = gam*i*cos((rC - r_maxC )*k(7))*k(7) - i*(ak/(one + tanh((rC - r2C)*k(2))*k( &
      1) + tanh((rC - r3C)*k(2))*k(1) + tanh((rC - r_maxC )*k(2))*k(1) + &
    ...
    S_4 = gam*i*cos((rC - r_maxC )*k(6))*k(6) + i*mC*cos((rC - r_maxC )*k(5))*k(5)/rC - &
      i*(ak/(one + tanh((rC - r2C)*k(2))*k(1) + tanh((rC - r3C)*k(2))*k(1) &
      + tanh((rC - r_maxC )*k(2))*k(1) + tanh((r2C - r_maxC )*k(2))*k(1) + &
