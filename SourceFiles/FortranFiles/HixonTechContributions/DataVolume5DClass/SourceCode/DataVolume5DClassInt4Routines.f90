INTERFACE CreateObject
  MODULE PROCEDURE CreateDataVolume5DInt4Object
  MODULE PROCEDURE CreateDataVolume4DInt4Object
  MODULE PROCEDURE CreateDataVolume3DInt4Object
  MODULE PROCEDURE CreateDataVolume2DInt4Object
  MODULE PROCEDURE CreateDataVolume1DInt4Object
  MODULE PROCEDURE CreateDataVolumeInt4ObjectFromFile
...
INTERFACE WriteObjectDataToFile
  MODULE PROCEDURE WriteDataVolumeInt4ObjectDataToFileV1SV1
END INTERFACE WriteObjectDataToFile

INTERFACE DestroyObject
  MODULE PROCEDURE DestroyDataVolume5DInt4Object
...
SUBROUTINE CreateDataVolume5DInt4Object(object,                 &
  ...
  TYPE(DataVolume5DInt4Type), INTENT(INOUT) :: object
  INTEGER, DIMENSION(:,:), INTENT(IN) :: bufferVolumeDataBounds  ! 5,2 is needed
  INTEGER(KIND=int4Def), DIMENSION(bufferVolumeDataBounds(1,1):, &
...
! local data
  ...
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume5DInt4Object (2)'
...
END SUBROUTINE CreateDataVolume5DInt4Object

SUBROUTINE CreateDataVolume4DInt4Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,       &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume4DInt4Object (2)'
...
END SUBROUTINE CreateDataVolume4DInt4Object

SUBROUTINE CreateDataVolume3DInt4Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume3DInt4Object (2)'
...
END SUBROUTINE CreateDataVolume3DInt4Object

SUBROUTINE CreateDataVolume2DInt4Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume2DInt4Object (2)'
...
END SUBROUTINE CreateDataVolume2DInt4Object

SUBROUTINE CreateDataVolume1DInt4Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume1DInt4Object (2)'
...
END SUBROUTINE CreateDataVolume1DInt4Object

SUBROUTINE CreateDataVolumeInt4ObjectFromFile(object,                 &
                                                 bufferVolumeDataBounds, &
                                                 fileUnit,               &
                                                 fileIsFormatted,        &
                                                 nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolumeInt4ObjectFromFile (2)'
...
END SUBROUTINE CreateDataVolumeInt4ObjectFromFile

SUBROUTINE WriteDataVolumeInt4ObjectDataToFileV1SV1(object,                 &
                                                       bufferVolumeDataBounds, &
                                                       fileUnit,               &
                                                       fileIsFormatted,        &
                                                       nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE WriteDataVolumeInt4ObjectDataToFile (2)'
...
END SUBROUTINE WriteDataVolumeInt4ObjectDataToFileV1SV1

SUBROUTINE DestroyDataVolume5DInt4Object(object,            &
                                            nodeMPIDataObject, &
                                            enableChecking,    &
                                            errorInfoObject)
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE DestroyDataVolume5DInt4Object'
...
END SUBROUTINE DestroyDataVolume5DInt4Object
...
SUBROUTINE GetPointerToVolumeData5D(object,              &
  ...
  TYPE(DataVolume5DInt4Type), TARGET, INTENT(INOUT) :: object
...
SUBROUTINE AddVolumeDataToMPIStructureDefinition5D(structMessageObject,    &
  ...
  TYPE(mpiDataObjectType), INTENT(IN) :: nodeMPIDataObject
  TYPE(DataVolume5DInt4Type), INTENT(IN) :: messageData
...
SUBROUTINE CheckForPointerToVolumeData5D(dataVolumeObject,     &
  ...
  TYPE(DataVolume5DInt4Type), INTENT(IN) :: dataVolumeObject
