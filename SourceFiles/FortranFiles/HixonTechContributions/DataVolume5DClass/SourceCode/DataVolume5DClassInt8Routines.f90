INTERFACE CreateObject
  MODULE PROCEDURE CreateDataVolume5DInt8Object
  MODULE PROCEDURE CreateDataVolume4DInt8Object
  MODULE PROCEDURE CreateDataVolume3DInt8Object
  MODULE PROCEDURE CreateDataVolume2DInt8Object
  MODULE PROCEDURE CreateDataVolume1DInt8Object
  MODULE PROCEDURE CreateDataVolumeInt8ObjectFromFile
...
INTERFACE WriteObjectDataToFile
  MODULE PROCEDURE WriteDataVolumeInt8ObjectDataToFileV1SV1
END INTERFACE WriteObjectDataToFile

INTERFACE DestroyObject
  MODULE PROCEDURE DestroyDataVolume5DInt8Object
...
SUBROUTINE CreateDataVolume5DInt8Object(object,                 &
  ...
  TYPE(DataVolume5DInt8Type), INTENT(INOUT) :: object
  INTEGER, DIMENSION(:,:), INTENT(IN) :: bufferVolumeDataBounds  ! 5,2 is needed
  INTEGER(KIND=int8Def), DIMENSION(bufferVolumeDataBounds(1,1):, &
...
! local data
  ...
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume5DInt8Object (2)'
...
END SUBROUTINE CreateDataVolume5DInt8Object

SUBROUTINE CreateDataVolume4DInt8Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,       &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume4DInt8Object (2)'
...
END SUBROUTINE CreateDataVolume4DInt8Object

SUBROUTINE CreateDataVolume3DInt8Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume3DInt8Object (2)'
...
END SUBROUTINE CreateDataVolume3DInt8Object

SUBROUTINE CreateDataVolume2DInt8Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume2DInt8Object (2)'
...
END SUBROUTINE CreateDataVolume2DInt8Object

SUBROUTINE CreateDataVolume1DInt8Object(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume1DInt8Object (2)'
...
END SUBROUTINE CreateDataVolume1DInt8Object

SUBROUTINE CreateDataVolumeInt8ObjectFromFile(object,                 &
                                                 bufferVolumeDataBounds, &
                                                 fileUnit,               &
                                                 fileIsFormatted,        &
                                                 nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolumeInt8ObjectFromFile (2)'
...
END SUBROUTINE CreateDataVolumeInt8ObjectFromFile

SUBROUTINE WriteDataVolumeInt8ObjectDataToFileV1SV1(object,                 &
                                                       bufferVolumeDataBounds, &
                                                       fileUnit,               &
                                                       fileIsFormatted,        &
                                                       nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE WriteDataVolumeInt8ObjectDataToFile (2)'
...
END SUBROUTINE WriteDataVolumeInt8ObjectDataToFileV1SV1

SUBROUTINE DestroyDataVolume5DInt8Object(object,            &
                                            nodeMPIDataObject, &
                                            enableChecking,    &
                                            errorInfoObject)
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE DestroyDataVolume5DInt8Object'
...
END SUBROUTINE DestroyDataVolume5DInt8Object
...
SUBROUTINE GetPointerToVolumeData5D(object,              &
  ...
  TYPE(DataVolume5DInt8Type), TARGET, INTENT(INOUT) :: object
...
SUBROUTINE AddVolumeDataToMPIStructureDefinition5D(structMessageObject,    &
  ...
  TYPE(mpiDataObjectType), INTENT(IN) :: nodeMPIDataObject
  TYPE(DataVolume5DInt8Type), INTENT(IN) :: messageData
...
SUBROUTINE CheckForPointerToVolumeData5D(dataVolumeObject,     &
  ...
  TYPE(DataVolume5DInt8Type), INTENT(IN) :: dataVolumeObject
