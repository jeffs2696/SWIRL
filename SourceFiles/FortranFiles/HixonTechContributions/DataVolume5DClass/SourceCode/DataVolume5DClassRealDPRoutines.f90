INTERFACE CreateObject
  MODULE PROCEDURE CreateDataVolume5DRealDPObject
  MODULE PROCEDURE CreateDataVolume4DRealDPObject
  MODULE PROCEDURE CreateDataVolume3DRealDPObject
  MODULE PROCEDURE CreateDataVolume2DRealDPObject
  MODULE PROCEDURE CreateDataVolume1DRealDPObject
  MODULE PROCEDURE CreateDataVolumeRealDPObjectFromFile
...
INTERFACE WriteObjectDataToFile
  MODULE PROCEDURE WriteDataVolumeRealDPObjectDataToFileV1SV1
END INTERFACE WriteObjectDataToFile

INTERFACE DestroyObject
  MODULE PROCEDURE DestroyDataVolume5DRealDPObject
...
SUBROUTINE CreateDataVolume5DRealDPObject(object,                 &
  ...
  TYPE(DataVolume5DRealDPType), INTENT(INOUT) :: object
  INTEGER, DIMENSION(:,:), INTENT(IN) :: bufferVolumeDataBounds  ! 5,2 is needed
  REAL(KIND=realDPDef), DIMENSION(bufferVolumeDataBounds(1,1):, &
...
! local data
  ...
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume5DRealDPObject (2)'
...
END SUBROUTINE CreateDataVolume5DRealDPObject

SUBROUTINE CreateDataVolume4DRealDPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,       &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume4DRealDPObject (2)'
...
END SUBROUTINE CreateDataVolume4DRealDPObject

SUBROUTINE CreateDataVolume3DRealDPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume3DRealDPObject (2)'
...
END SUBROUTINE CreateDataVolume3DRealDPObject

SUBROUTINE CreateDataVolume2DRealDPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume2DRealDPObject (2)'
...
END SUBROUTINE CreateDataVolume2DRealDPObject

SUBROUTINE CreateDataVolume1DRealDPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume1DRealDPObject (2)'
...
END SUBROUTINE CreateDataVolume1DRealDPObject

SUBROUTINE CreateDataVolumeRealDPObjectFromFile(object,                 &
                                                 bufferVolumeDataBounds, &
                                                 fileUnit,               &
                                                 fileIsFormatted,        &
                                                 nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolumeRealDPObjectFromFile (2)'
...
END SUBROUTINE CreateDataVolumeRealDPObjectFromFile

SUBROUTINE WriteDataVolumeRealDPObjectDataToFileV1SV1(object,                 &
                                                       bufferVolumeDataBounds, &
                                                       fileUnit,               &
                                                       fileIsFormatted,        &
                                                       nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE WriteDataVolumeRealDPObjectDataToFile (2)'
...
END SUBROUTINE WriteDataVolumeRealDPObjectDataToFileV1SV1

SUBROUTINE DestroyDataVolume5DRealDPObject(object,            &
                                            nodeMPIDataObject, &
                                            enableChecking,    &
                                            errorInfoObject)
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE DestroyDataVolume5DRealDPObject'
...
END SUBROUTINE DestroyDataVolume5DRealDPObject
...
SUBROUTINE GetPointerToVolumeData5D(object,              &
  ...
  TYPE(DataVolume5DRealDPType), TARGET, INTENT(INOUT) :: object
...
SUBROUTINE AddVolumeDataToMPIStructureDefinition5D(structMessageObject,    &
  ...
  TYPE(mpiDataObjectType), INTENT(IN) :: nodeMPIDataObject
  TYPE(DataVolume5DRealDPType), INTENT(IN) :: messageData
...
SUBROUTINE CheckForPointerToVolumeData5D(dataVolumeObject,     &
  ...
  TYPE(DataVolume5DRealDPType), INTENT(IN) :: dataVolumeObject
