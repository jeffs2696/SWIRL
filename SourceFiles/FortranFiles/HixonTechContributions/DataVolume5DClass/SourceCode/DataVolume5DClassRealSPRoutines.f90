INTERFACE CreateObject
  MODULE PROCEDURE CreateDataVolume5DRealSPObject
  MODULE PROCEDURE CreateDataVolume4DRealSPObject
  MODULE PROCEDURE CreateDataVolume3DRealSPObject
  MODULE PROCEDURE CreateDataVolume2DRealSPObject
  MODULE PROCEDURE CreateDataVolume1DRealSPObject
  MODULE PROCEDURE CreateDataVolumeRealSPObjectFromFile
...
INTERFACE WriteObjectDataToFile
  MODULE PROCEDURE WriteDataVolumeRealSPObjectDataToFileV1SV1
END INTERFACE WriteObjectDataToFile

INTERFACE DestroyObject
  MODULE PROCEDURE DestroyDataVolume5DRealSPObject
...
SUBROUTINE CreateDataVolume5DRealSPObject(object,                 &
  ...
  TYPE(DataVolume5DRealSPType), INTENT(INOUT) :: object
  INTEGER, DIMENSION(:,:), INTENT(IN) :: bufferVolumeDataBounds  ! 5,2 is needed
  REAL(KIND=realSPDef), DIMENSION(bufferVolumeDataBounds(1,1):, &
...
! local data
  ...
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume5DRealSPObject (2)'
...
END SUBROUTINE CreateDataVolume5DRealSPObject

SUBROUTINE CreateDataVolume4DRealSPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,       &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume4DRealSPObject (2)'
...
END SUBROUTINE CreateDataVolume4DRealSPObject

SUBROUTINE CreateDataVolume3DRealSPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume3DRealSPObject (2)'
...
END SUBROUTINE CreateDataVolume3DRealSPObject

SUBROUTINE CreateDataVolume2DRealSPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume2DRealSPObject (2)'
...
END SUBROUTINE CreateDataVolume2DRealSPObject

SUBROUTINE CreateDataVolume1DRealSPObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume1DRealSPObject (2)'
...
END SUBROUTINE CreateDataVolume1DRealSPObject

SUBROUTINE CreateDataVolumeRealSPObjectFromFile(object,                 &
                                                 bufferVolumeDataBounds, &
                                                 fileUnit,               &
                                                 fileIsFormatted,        &
                                                 nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolumeRealSPObjectFromFile (2)'
...
END SUBROUTINE CreateDataVolumeRealSPObjectFromFile

SUBROUTINE WriteDataVolumeRealSPObjectDataToFileV1SV1(object,                 &
                                                       bufferVolumeDataBounds, &
                                                       fileUnit,               &
                                                       fileIsFormatted,        &
                                                       nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE WriteDataVolumeRealSPObjectDataToFile (2)'
...
END SUBROUTINE WriteDataVolumeRealSPObjectDataToFileV1SV1

SUBROUTINE DestroyDataVolume5DRealSPObject(object,            &
                                            nodeMPIDataObject, &
                                            enableChecking,    &
                                            errorInfoObject)
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE DestroyDataVolume5DRealSPObject'
...
END SUBROUTINE DestroyDataVolume5DRealSPObject
...
SUBROUTINE GetPointerToVolumeData5D(object,              &
  ...
  TYPE(DataVolume5DRealSPType), TARGET, INTENT(INOUT) :: object
...
SUBROUTINE AddVolumeDataToMPIStructureDefinition5D(structMessageObject,    &
  ...
  TYPE(mpiDataObjectType), INTENT(IN) :: nodeMPIDataObject
  TYPE(DataVolume5DRealSPType), INTENT(IN) :: messageData
...
SUBROUTINE CheckForPointerToVolumeData5D(dataVolumeObject,     &
  ...
  TYPE(DataVolume5DRealSPType), INTENT(IN) :: dataVolumeObject
