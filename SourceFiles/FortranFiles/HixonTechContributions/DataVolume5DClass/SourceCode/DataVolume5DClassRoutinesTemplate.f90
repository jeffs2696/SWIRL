INTERFACE CreateObject
  MODULE PROCEDURE CreateDataVolume5DVarTypeObject
  MODULE PROCEDURE CreateDataVolume4DVarTypeObject
  MODULE PROCEDURE CreateDataVolume3DVarTypeObject
  MODULE PROCEDURE CreateDataVolume2DVarTypeObject
  MODULE PROCEDURE CreateDataVolume1DVarTypeObject
  MODULE PROCEDURE CreateDataVolumeVarTypeObjectFromFile
...
INTERFACE WriteObjectDataToFile
  MODULE PROCEDURE WriteDataVolumeVarTypeObjectDataToFileV1SV1
END INTERFACE WriteObjectDataToFile

INTERFACE DestroyObject
  MODULE PROCEDURE DestroyDataVolume5DVarTypeObject
...
SUBROUTINE CreateDataVolume5DVarTypeObject(object,                 &
  ...
  TYPE(DataVolume5DVarTypeType), INTENT(INOUT) :: object
  INTEGER, DIMENSION(:,:), INTENT(IN) :: bufferVolumeDataBounds  ! 5,2 is needed
  IntOrReal, DIMENSION(bufferVolumeDataBounds(1,1):, &
...
! local data
  ...
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume5DVarTypeObject (2)'
...
END SUBROUTINE CreateDataVolume5DVarTypeObject

SUBROUTINE CreateDataVolume4DVarTypeObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,       &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume4DVarTypeObject (2)'
...
END SUBROUTINE CreateDataVolume4DVarTypeObject

SUBROUTINE CreateDataVolume3DVarTypeObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume3DVarTypeObject (2)'
...
END SUBROUTINE CreateDataVolume3DVarTypeObject

SUBROUTINE CreateDataVolume2DVarTypeObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume2DVarTypeObject (2)'
...
END SUBROUTINE CreateDataVolume2DVarTypeObject

SUBROUTINE CreateDataVolume1DVarTypeObject(object,                 &
                                           bufferVolumeDataBounds, &
                                           bufferVolumeData,     &
                                           nodeMPIDataObject,      &
                                           enableChecking,         &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolume1DVarTypeObject (2)'
...
END SUBROUTINE CreateDataVolume1DVarTypeObject

SUBROUTINE CreateDataVolumeVarTypeObjectFromFile(object,                 &
                                                 bufferVolumeDataBounds, &
                                                 fileUnit,               &
                                                 fileIsFormatted,        &
                                                 nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE CreateDataVolumeVarTypeObjectFromFile (2)'
...
END SUBROUTINE CreateDataVolumeVarTypeObjectFromFile

SUBROUTINE WriteDataVolumeVarTypeObjectDataToFileV1SV1(object,                 &
                                                       bufferVolumeDataBounds, &
                                                       fileUnit,               &
                                                       fileIsFormatted,        &
                                                       nodeMPIDataObject,      &
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE WriteDataVolumeVarTypeObjectDataToFile (2)'
...
END SUBROUTINE WriteDataVolumeVarTypeObjectDataToFileV1SV1

SUBROUTINE DestroyDataVolume5DVarTypeObject(object,            &
                                            nodeMPIDataObject, &
                                            enableChecking,    &
                                            errorInfoObject)
...
! local data
  ...
  CHARACTER(LEN=80) :: errorInformation
  CHARACTER(LEN=*), PARAMETER :: location = &
    'SUBROUTINE DestroyDataVolume5DVarTypeObject'
...
END SUBROUTINE DestroyDataVolume5DVarTypeObject
...
SUBROUTINE GetPointerToVolumeData5D(object,              &
  ...
  TYPE(DataVolume5DVarTypeType), TARGET, INTENT(INOUT) :: object
...
SUBROUTINE AddVolumeDataToMPIStructureDefinition5D(structMessageObject,    &
  ...
  TYPE(mpiDataObjectType), INTENT(IN) :: nodeMPIDataObject
  TYPE(DataVolume5DVarTypeType), INTENT(IN) :: messageData
...
SUBROUTINE CheckForPointerToVolumeData5D(dataVolumeObject,     &
  ...
  TYPE(DataVolume5DVarTypeType), INTENT(IN) :: dataVolumeObject
