MODULE MPI_GET_ADDRESSInt8Call
...
CONTAINS
  ...
  SUBROUTINE MPI_GET_ADDRESSInt81(LOCATION, ADDRESS, IERROR)
    INTEGER(KIND=int8Kind), DIMENSION(:)  , INTENT(IN)  :: LOCATION
...
END MODULE MPI_GET_ADDRESSInt8Call

MODULE MPI_GET_ADDRESSInt8Module
  USE IncludeMPIImplementation
  USE MPI_GET_ADDRESSInt8Call
  USE MPIKindDefs
...
END MODULE MPI_GET_ADDRESSInt8Module
