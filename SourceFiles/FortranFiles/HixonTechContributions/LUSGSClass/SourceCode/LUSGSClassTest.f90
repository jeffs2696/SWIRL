PROGRAM MAIN
  ...
  USE LUSGSClassTest_General
  USE LUSGSClassTest_LAPACK
  USE LUSGSClassTest_1D
  USE LUSGSClassTest_2D
  USE LUSGSClassTest_3D
  USE LUSGSClassTest_4D
  IMPLICIT NONE
...
!----------------create the errorInfoObject---------------------
  ...
  CALL LUSGSClassTestGeneral(LUSGSObject       = LUSGSObject,     &
  ...
  CALL LUSGSClassTestLAPACK(LUSGSObject       = LUSGSObject,     &
                            masterNode        = masterNode,      &
                            enableChecking    = enableChecking,  &
                            errorInfoObject   = errorInfoObject)
...
! 1D testing
  ...
  CALL LUSGSClassTest1D(LUSGSObject       = LUSGSObject,     &
                        masterNode        = masterNode,      &
                        enableChecking    = enableChecking,  &
                        errorInfoObject   = errorInfoObject)
...
! 2D testing
  ...
  CALL LUSGSClassTest2D(LUSGSObject       = LUSGSObject,     &
                        masterNode        = masterNode,      &
                        enableChecking    = enableChecking,  &
                        errorInfoObject   = errorInfoObject)
...
! 3D testing
  ...
  CALL LUSGSClassTest3D(LUSGSObject       = LUSGSObject,     &
                        masterNode        = masterNode,      &
                        enableChecking    = enableChecking,  &
                        errorInfoObject   = errorInfoObject)
...
! 4D testing
  ...
  CALL LUSGSClassTest4D(LUSGSObject       = LUSGSObject,     &
                        masterNode        = masterNode,      &
                        enableChecking    = enableChecking,  &
                        errorInfoObject   = errorInfoObject)
 ...
 100 CONTINUE
  ...
  IF (passedTest) THEN
   IF (masterNode) THEN
    WRITE(0,999)
    OPEN(33,FILE = 'LUSGSClassTest.PASSED',FORM = 'FORMATTED')
    WRITE(33,999)
    CLOSE(33)
   END IF
  ELSE
   IF (masterNode) THEN
    WRITE(0,998)
    OPEN(33,FILE = 'LUSGSClassTest.FAILED',FORM = 'FORMATTED')
    WRITE(33,998)
    CLOSE(33)
   END IF
  END IF
 ...
 1x,'|       LUSGS Object                      |',/,&
 1x,'|      testing routines                   |',/,&
 1x,'|  copyright 2022 by Hixon Technology     |',/,&
