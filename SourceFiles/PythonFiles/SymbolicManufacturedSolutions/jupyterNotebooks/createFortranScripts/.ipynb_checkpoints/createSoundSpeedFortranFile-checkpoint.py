...
def createSoundSpeedFortranFile(A_analytic,M_t_analytic,M_x_analytic):
    ...
    #f_M_x = re.sub(r"\*\*2","**2.0_rDef",f_M_x)
    ...
    f_M_x = re.sub(r"r\*","r(i)*",f_M_x)
    f_M_x = re.sub(r"k\(1\)","kR(1)",f_M_x)
    f_M_x = re.sub(r"k\(2\)","kR(2)",f_M_x)
    f_M_x = re.sub(r"k\(","kR(",f_M_x)
    ...
    #print("SoundSpeedMMS.f90 below")    
    #with open('../../FortranFiles/SoundSpeedMMS.f90','r') as f:
    #    for line in f:
    #        print(line)
    return