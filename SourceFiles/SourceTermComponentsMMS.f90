...
S_A13=0
S_A14=((-6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - 125.0d0)**2)*tanh(125.0d0* &
      r - 125.0d0) - 6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - &
      91.666666666666671d0)**2)*tanh(125.0d0*r - 91.666666666666671d0) &
      - 6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - 58.333333333333336d0 &
      )**2)*tanh(125.0d0*r - 58.333333333333336d0) - 6.25d0*(250.0d0 - &
      250.0d0*tanh(125.0d0*r - 25.0d0)**2)*tanh(125.0d0*r - 25.0d0) + &
      13.73291015625d0*(r - 0.2d0)**4 - 13.671875d0*(r - 0.2d0)**3 - &
      1.17187499999999d0*(r - 0.2d0)**2 + 0.875d0)/(0.875d0*r + &
      2.74658203125d0*(r - 0.2d0)**5 - 3.41796875d0*(r - 0.2d0)**4 - &
      0.390624999999998d0*(r - 0.2d0)**3 - 6.25d0*tanh(125.0d0*r - &
      125.0d0)**2 - 6.25d0*tanh(125.0d0*r - 91.666666666666671d0)**2 - &
      6.25d0*tanh(125.0d0*r - 58.333333333333336d0)**2 - 6.25d0*tanh( &
      125.0d0*r - 25.0d0)**2 + 24.825d0) + (1.58113883008419d0*sqrt(r*( &
      ...
      one)/r)*(0.875d0*r + 2.74658203125d0*(r - 0.2d0)**5 - &
...
S_A22=-i*(ak/(0.001d0*tanh(10.0d0*r - 10.0d0) + 0.001d0*tanh(10.0d0*r - 7.5d0 &
      ...
      0.866703538980562d0)
S_A23=0
S_A24=i*mC*(0.875d0*r + 2.74658203125d0*(r - 0.2d0)**5 - 3.41796875d0*(r - &
...
S_A34=0
S_A41=(one/r + (-6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - 125.0d0)**2)*tanh( &
      125.0d0*r - 125.0d0) - 6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - &
      91.666666666666671d0)**2)*tanh(125.0d0*r - 91.666666666666671d0) &
      - 6.25d0*(250.0d0 - 250.0d0*tanh(125.0d0*r - 58.333333333333336d0 &
      )**2)*tanh(125.0d0*r - 58.333333333333336d0) - 6.25d0*(250.0d0 - &
      250.0d0*tanh(125.0d0*r - 25.0d0)**2)*tanh(125.0d0*r - 25.0d0) + &
...
S_B11=-gam*i*(0.00833333333333333d0*tanh(125.0d0*r - 125.0d0) + &
      ...
      0.00833333333333333d0*tanh(125.0d0*r - 50.0d0) + &
      0.00833333333333333d0*tanh(125.0d0*r - 25.0d0) + &
      0.166666666666667d0)*(0.875d0*r + 2.74658203125d0*(r - 0.2d0)**5 &
      - 3.41796875d0*(r - 0.2d0)**4 - 0.390624999999998d0*(r - 0.2d0)** &
      3 - 6.25d0*tanh(125.0d0*r - 125.0d0)**2 - 6.25d0*tanh(125.0d0*r - &
      91.666666666666671d0)**2 - 6.25d0*tanh(125.0d0*r - &
      58.333333333333336d0)**2 - 6.25d0*tanh(125.0d0*r - 25.0d0)**2 + &
      24.825d0)
S_B12=0
...
S_B33=-gam*i*(0.1d0*tanh(25.0d0*r - 25.0d0) + 0.1d0*tanh(25.0d0*r - &
      ...
      0.00833333333333333d0*tanh(125.0d0*r - 25.0d0) + &
      0.166666666666667d0)
S_B34=-gam*i*one*(0.875d0*r + 2.74658203125d0*(r - 0.2d0)**5 - 3.41796875d0* &
